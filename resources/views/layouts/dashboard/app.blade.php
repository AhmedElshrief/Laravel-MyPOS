...
{{--                          </div>--}}
                          <div>
                              ...
                              <form action="{{ route('logout') }}" method="post">
                                  @csrf
                                  <input class="form-control" type="submit" value="@lang('site.logout')">
                              </form>
        ...
        <script>
            ...
            $(".delete").click(function (e) {
                ...
                let n = new Noty({
                    ...
                    killer: true,
                    buttons: [
                        Noty.button("@lang('site.yes')", 'btn btn-success m-2', function () {
                            that.closest('form').submit();
                        }),
                        Noty.button("@lang('site.no')", 'btn btn-danger m-2', function () {
                            n.close();
                        })
                    ]   //End of button
                });
